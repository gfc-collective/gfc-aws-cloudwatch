...
A fork and new home of the former Gilt Foundation Classes (`org.gfccollective.gfc`), now called the [GFC Collective](https://github.com/gfc-collective), maintained by some of the original authors.
